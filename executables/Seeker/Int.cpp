...
#if NB64BLOCK > 5
  return (bits64[8] | bits64[7] | bits64[6] | bits64[5] | bits64[4] | bits64[3] | bits64[2] | bits64[1] | bits64[0]) ==
         0;
#else
...
uint32_t Int::GetInt32() { return bits32[0]; }
...
void Int::SetDWord(int n, uint32_t b) { bits32[n] = b; }
...
bool Int::IsEven() const { return (bits32[0] & 0x1) == 0; }

// ------------------------------------------------

bool Int::IsOdd() const { return (bits32[0] & 0x1) == 1; }
...
void Int::Check() {
  ...
  e.SetBase10("18455550949219347416408737317718791970549095026991927302832204862407246876612578942266609480026503412404"
              "52881231721004292250660431557118");
  ...
  // Modular arithmetic -------------------------------------------------------------------------------
  // SecpK1 prime
  b.SetBase16("ffffffffffffffffffffffffffffffff000000000000000000000001");
