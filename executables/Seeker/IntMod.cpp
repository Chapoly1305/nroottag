...
const uint64_t Int::GetMM64() { return MM64; }
...
static Int R1BitFolding;

void Int::InitR1() { R1BitFolding.SetBase16("ffffffffffffffffffffffff"); }

void Int::ModMulR1(Int *a, Int *b) {
#ifndef WIN64
#if (__GNUC__ > 7) || (__GNUC__ == 7 && (__GNUC_MINOR__ > 2))
  unsigned char c;
#else
#warning "GCC lass than 7.3 detected, upgrade gcc to get best perfromance"
  ...
  // Reduce from 448 to 320
  uint32_t *r51232 = (uint32_t *)(r512);
  tt.bits64[0] = *((uint64_t *)(r51232 + 7));
  tt.bits64[1] = *((uint64_t *)(r51232 + 9));
  tt.bits64[2] = *((uint64_t *)(r51232 + 11));
  tt.bits64[3] = *((uint64_t *)(r51232 + 13));
  tt.bits64[4] = 0;
  sub = tt;
  tt.ShiftL(96);
  tt.Sub(&sub);

  c = _addcarry_u64(0, r512[0], tt.bits64[0], r512 + 0);
  c = _addcarry_u64(c, r512[1], tt.bits64[1], r512 + 1);
  c = _addcarry_u64(c, r512[2], tt.bits64[2], r512 + 2);
  c = _addcarry_u64(c, (uint64_t)((uint32_t)(r512[3])), (uint64_t)((uint32_t)(tt.bits64[3])), r512 + 3);

  ttHigh.bits64[0] = *((uint64_t *)(tt.bits32 + 7)) + ((uint8_t *)(r512 + 3))[4];
  ttHigh.bits64[1] = (uint64_t)(tt.bits32[9]);
  ttHigh.bits64[2] = 0;
  ttHigh.bits64[3] = 0;
  ttHigh.bits64[4] = 0;
  sub = ttHigh;
  ...
  c = _addcarry_u64(0, r512[0], ttHigh.bits64[0], bits64 + 0);
  c = _addcarry_u64(c, r512[1], ttHigh.bits64[1], bits64 + 1);
  c = _addcarry_u64(c, r512[2], ttHigh.bits64[2], bits64 + 2);
